...
voidpf ZCALLBACK fopen_mem_func (
   voidpf opaque,
   const char* filename,
   int mode)
{
...
uLong ZCALLBACK fread_mem_func (
   voidpf opaque,
   voidpf stream,
   void* buf,
   uLong size)
...
uLong ZCALLBACK fwrite_mem_func (
   voidpf opaque,
   voidpf stream,
   const void* buf,
   uLong size)
...
void fill_memory_filefunc64_32 (zlib_filefunc64_32_def* pzlib_filefunc_def, ourmemory_t *ourmem)
{
