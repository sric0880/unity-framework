...
voidpf ZCALLBACK fopen_mem_func64_32 OF((voidpf opaque, const void* filename, int mode));
...
void fill_memory_filefunc64_32 OF((zlib_filefunc64_32_def* pzlib_filefunc_def, ourmemory_t *ourmem));
